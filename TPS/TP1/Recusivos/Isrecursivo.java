...
public class Isrecursivo {
    ...
    public static boolean Consoantes(String texto) {
        ...
        int tam = texto.length();
        for (int i = 0; i < tam; i++) {
            if (texto.charAt(i) >= 'b' && texto.charAt(i) <= 'd' || texto.charAt(i) >= 'f' && texto.charAt(i) <= 'h'
                    || texto.charAt(i) >= 'j' && texto.charAt(i) <= 'n' || texto.charAt(i) >= 'p' && texto.charAt(i) <= 't'
                    || texto.charAt(i) >= 'v' && texto.charAt(i) <= 'z') {
                pontos += 1;
            }
        }
        return pontos == tam;
    ...
    public static void processarTexto(Scanner ler) {
